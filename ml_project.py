...
# PRICE FEATURES (from order_items) - already added
# total_price, total_freight, num_items, avg_item_price, freight_ratio, unique_sellers already in df
...
try:
    ...
    model_name_xgb = 'GradientBoosting'
